      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-10 md:px-10">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center md:justify-start">
            ...
            <button onClick={handleDownloadCV} className="bg-white text-[#2563EB] px-6 py-3 rounded-md border-2 border-white hover:bg-[#2563EB] hover:text-white transition-all duration-300 flex items-center justify-center gap-2 font-medium shadow-lg hover:shadow-xl">
